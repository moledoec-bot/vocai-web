      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <span className="text-3xl font-black gradient-text">VOCAI</span>
            <p className="mt-5 text-slate-400 text-sm font-light leading-relaxed max-w-xs">
              La voz de tu negocio, potenciada por IA. Estudio de podcast, marketing digital e inteligencia artificial en Alicante.
            </p>
          </div>
          ...
          {/* Redes */}
          <div>
            <h3 className="text-white font-bold text-xs uppercase tracking-widest mb-5">Redes</h3>
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 text-slate-400 hover:text-white text-sm font-light transition-colors duration-300"
                >
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-slate-500 text-xs font-light">
            Diseñado y construido en Alicante
          </p>
        </div>
      </div>
    </footer>
